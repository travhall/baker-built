...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Fill out the work-order request below or call direct. You'll hear back within one business day — from the person who'll actually do the work.",
  },
};
          ...
          <div className="estimate-card reveal d1">
            ...
            <div className="info-side reveal d1">
              ...
              <div className="info-block">
                ...
                <div className="sub">
                  Serving the Twin Cities metro &amp; surrounding suburbs
                </div>
              </div>
              <div className="info-block">
                <div className="k">Languages</div>
          ...
          <div style={{ marginTop: "54px" }}>
            ...
            <div className="next-steps reveal d1">
              <div className="step">
                ...
                <p>
                  Nate calls back within a business day to understand the scope,
                  the site, and what you&apos;re hoping for.
                </p>
              </div>
              <div className="step">
                ...
                <h4>On-site walk</h4>
                <p>
                  A visit to measure, look at the real conditions, and flag
                  anything that affects the plan or the price.
                </p>
              </div>
              <div className="step">
                ...
                <p>
                  A written estimate with the scope spelled out — no vague line
                  items, no pressure, no charge.
                </p>
              </div>
            </div>
          </div>
