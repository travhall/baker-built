  ...
  return (
    <div style={{ background: "var(--paper)", minHeight: "100vh" }}>
        ...
        <div className="wrap">
          <div className="pj-mast-top">
            ...
            <p className="pj-summary">
              Tokens, type scale, components, and patterns used across the Baker
              Built site. <span className="em">Blueprint × Craftsmanship</span>{" "}
          ...
          <div className="titlestrip">
            ...
            <div className="cell">
              ...
              <div className="v">10 Tokens</div>
            </div>
            <div className="cell">
              <div className="k">Components</div>
              <div className="v">12+ Types</div>
            </div>
            <div className="cell">
      ...
      >
        ...
        <div className="mono" style={{ marginBottom: "12px" }}>
          3-column card grid — .spec-grid / .spec — hover shows blueprint corner
          tick
        </div>
          ...
          {[
            {
              ...
              desc: "Kitchens, baths, and basement finishes.",
              tags: ["Kitchen", "Bath", "Basement"],
            },
            {
              no: "S‑02",
              title: "Roofing",
              desc: "Asphalt shingle installation and full tear-off replacement.",
              tags: ["Tear-off", "Shingle", "Repair"],
            },
            {
              no: "S‑03",
              title: "Window Replacement",
              desc: "Full-frame casement, picture, and safety-glazed units.",
              tags: ["Full-frame", "Casement", "Picture"],
            },
            ...
            <div className="spec" key={no}>
              ...
              <div style={{ marginBottom: "16px", marginTop: "18px" }}>
                <svg
                  ...
                  strokeWidth="1.4"
                >
                  <rect x="3" y="10" width="16" height="20" />
                  <rect x="13" y="3" width="18" height="27" />
                </svg>
              </div>
              <h3>{title}</h3>
              <p>{desc}</p>
        ...
        <div className="mono" style={{ marginBottom: "12px" }}>
          Project index card — .work-card — hover lifts with shadow. Last meta
          cell turns accent on hover.
        </div>
        <div
          className="work-grid"
        ...
        >
          <article className="work-card">
            <div className="plate ticks">
              ...
              <span className="tick br"></span>
              <div className="plate-inner">
                <div className="img-ph work-slot">
                  <span>Kitchen &amp; main-floor remodel</span>
                </div>
              </div>
              <div className="work-block">
                ...
                <div className="wb-meta">
                  <div>
                    <div className="tk">Scope</div>
                    <div className="tv">Whole-Home</div>
                  </div>
                  <div>
                    <div className="tk">Location</div>
                    <div className="tv">North Minneapolis</div>
                  </div>
                  <div>
                    <div className="tk">Sheet</div>
                    <div className="tv">PRJ‑01</div>
                  </div>
                </div>
                <Link className="wb-open" href="/work/kitchen-remodel">
                  View Project Sheet <span className="arw">→</span>
                </Link>
              </div>
            </div>
          </article>
            ...
            <div className="plate ticks">
              ...
              <div className="work-block">
                ...
                <div className="wb-meta">
                  <div>
                    <div className="tk">Scope</div>
                    <div className="tv">Windows</div>
                  </div>
                  <div>
                    <div className="tk">Location</div>
                    <div className="tv">Webber–Camden</div>
                  </div>
                  <div>
                    <div className="tk">Sheet</div>
                    <div className="tv">PRJ‑03</div>
                  </div>
                </div>
                <div className="wb-open pending">
                  <span className="st">Sheet in progress</span>
                </div>
              </div>
            </div>
          </article>
        ...
        <div className="mono" style={{ marginBottom: "12px" }}>
          Scope / trade labels — used in spec cards, trade rows, and build
          phases
        </div>
        ...
        <div className="mono" style={{ marginBottom: "12px" }}>
          Work order form — .field, inputs, select, textarea — focus ring uses
          accent red
        </div>
        <div
          style={{
        ...
        >
          <div style={{ padding: "32px 36px" }}>
            <div className="field row2">
              ...
              <div>
                <label>Phone</label>
                <input type="tel" placeholder="(612) 000‑0000" />
              </div>
            </div>
            <div className="field">
        ...
        <div className="mono" style={{ marginBottom: "12px" }}>
          Proof section — dark ink background, noise texture, stat row + quote
          cards
        </div>
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              <div className="stat-row" style={{ marginTop: 0 }}>
                ...
                <div className="stat">
                  ...
                  <div className="k">Years Hands-On</div>
                </div>
                <div className="stat">
                  <div className="v">2017</div>
                  <div className="k">LLC Established</div>
                </div>
                <div className="stat">
                  <div className="v">
                    100<span className="u">%</span>
                  </div>
                  <div className="k">Nate, On Site</div>
                </div>
              </div>
              <div className="quotes" style={{ marginTop: "24px" }}>
                ...
                <div className="quote empty">
                  ...
                  >
                    Awaiting · Plate Reserved
                  </div>
                  <p>
                    Your review goes here — collected as each Twin Cities
                    project wraps.
                  </p>
