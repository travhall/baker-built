...
export default function EstimateForm() {
  ...
  async function handleSubmit(e: SubmitEvent<HTMLFormElement>) {
    ...
    const data = Object.fromEntries(new FormData(form) as any) as Record<
      string,
      string
    >;
  ...
  return (
    ...
    >
      ...
      <div className="field">
        <label htmlFor="est-address">Project Address</label>
        <input
          id="est-address"
          type="text"
          name="address"
      ...
      <div className="field">
        ...
        <textarea
          id="est-desc"
          name="desc"
          placeholder="What are you looking to build, repair, or replace? Rough timeline if you have one."
        ></textarea>
      </div>
      <button
      ...
      <div className="form-note">
        Or call direct: (612) 964‑3505 · Mon–Fri 8AM–5PM
      </div>
      {status === "success" && (
        <div
          ref={statusRef}
